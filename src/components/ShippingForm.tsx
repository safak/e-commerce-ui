    ...
    return (
        <form className="flex flex-col gap-4" onSubmit={handleSubmit(handleShippingForm)}>
          <div className="flex flex-col gap-1">
            ...
            <input
              className="border-b border-gray-200 py-2 outline-none  text-sm" type="text" id="name" placeholder="john Doe" {...register("name")} />
            {errors.name && (
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              className="border-b border-gray-200 py-2 outline-none  text-sm" type="text" id="email" placeholder="johndoe@gmail.com" {...register("email")} />
            {errors.email && (
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              className="border-b border-gray-200 py-2 outline-none  text-sm" type="text" id="phone" placeholder="0123456789" {...register("phone")} />
            {errors.phone && (
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              className="border-b border-gray-200 py-2 outline-none  text-sm" type="text" id="address" placeholder="123 Main St, Anytown" {...register("address")} />
            {errors.address && (
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
                className="border-b border-gray-200 py-2 outline-none  text-sm" type="text" id="city" placeholder="New York" {...register("city")} />
            {errors.city && (
